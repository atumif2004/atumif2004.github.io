...
<body>
	<div id="container">				
		...
		<div id="navi">
			<ul><li><a href="/services/">Услуги</a></li><li><a href="/about/">О компании</a></li><li><a href="/portfolio/">Примеры работ</a></li><li><a href="/contacts/">Контактная информация</a></li></ul>
		</div>
		<div class="navline"></div>
		<div id="topBanner"></div>
		<div class="topEndLine"></div>
		<div class="LineStat">
			<a href="/">Ландшафтный дизайн</a> / <a href="/sitemap/">Карта сайта</a> / <span style="color:#336600">404 - Страница не найдена</span>	
		</div>

		<div class="pageCont">
			<h1>Ошибка 404</h1>
<p>К сожалению, такой страницы на сайте не существует.</p>
<p>Воспользуйтесь меню в верхней части сайта, или перейдите на <a href="/">главную страницу</a>.</p>
		</div>		
		...
		<div id="footer">		
			...
			<div class="copir">
				...
				<!--Телефон: 8 495 782-74-37, эл. почта: <a href="mailto:info@silvadesign.ru">info@silvadesign.ru</a><br />

				Адрес: г. Москва, Зеленоград, ул. Юности, дом 8-->
			</div><div class="partners">Наши партнеры: <!-- trade-links --></div>
